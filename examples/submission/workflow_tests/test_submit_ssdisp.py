...
parser.add_argument(
    '--inpgen', type=int, dest='inpgen', help='The inpgen code node to use', required=True
)
parser.add_argument(
...
wf_para = Dict(
    dict={
        ...
        'q_vectors': [[0.0, 0.0, 0.0], [0.125, 0.125, 0.0], [0.250, 0.250, 0.0],
                      [0.375, 0.375, 0.0], [0.500, 0.500, 0.0]],
        'ref_qss': [0.0, 0.0, 0.0],
        'inpxml_changes': []
    }
)
...
if submit_wc:
    ...
    res = run(FleurSSDispWorkChain, **inputs)
