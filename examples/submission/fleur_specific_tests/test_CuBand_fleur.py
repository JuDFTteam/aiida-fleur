...
inpxmlfile = '/usr/users/iff_th1/broeder/aiida/github/aiida_fleur_plugin/tests/inp_xml_files/CuBandXML/files/inp.xml'
enpara = '/usr/users/iff_th1/broeder/aiida/github/aiida_fleur_plugin/tests/inp_xml_files/CuBandXML/files/enpara'
...
calc = code.new_calc()
calc.label = 'Cu Band Fleur test'
calc.description = ('Simple test of Fleur band structure calculation with XML input with one step:'
                    '1.Generate a starting density, run 1 iteration, and generate band structure.'
                    'Ensure that the files are created.')
