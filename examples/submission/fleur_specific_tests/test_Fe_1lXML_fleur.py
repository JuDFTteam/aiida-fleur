...
inpxmlfile = '/usr/users/iff_th1/broeder/aiida/github/aiida_fleur_plugin/tests/inp_xml_files/Fe_1lXML/files/inp.xml'
enpara = '/usr/users/iff_th1/broeder/aiida/github/aiida_fleur_plugin/tests/inp_xml_files/Fe_1lXML/files/enpara'
symout = '/usr/users/iff_th1/broeder/aiida/github/aiida_fleur_plugin/tests/inp_xml_files/Fe_1lXML/files/sym.out'
...
calc = code.new_calc()
calc.label = "Fe_1l Fleur test"
calc.description = ("Simple test of Fleur with one step:"
