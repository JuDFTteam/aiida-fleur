...
class FleurinpData(Data):
    ...
    def _set_inp_dict(self):
        ...
        4. set inputxml_dict
        """
        from aiida.tools.codespecific.fleur.xml_util import get_inpxml_file_structure, inpxml_todict
    ...
    def set_xpath(self, xpath, value):
        ...
        """
        from aiida.tools.codespecific.fleur.xml_util import xml_set_all_attribv, xml_set_text
