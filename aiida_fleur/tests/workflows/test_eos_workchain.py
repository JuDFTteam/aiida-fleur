...
class Test_FleurEosWorkChain():
    """
    Regression tests for the v
    """
    @pytest.mark.skip(reason="Test is not implemented")
    @pytest.mark.timeout(500, method='thread')
    def test_fleur_eos_fleurinp_Si(self, run_with_cache, mock_code_factory, create_fleurinp):
        """
        ...
        builder.metadata.description = 'Simple Fleur FleurEosWorkChain test for Si bulk with fleurinp data given'
    ...
    @pytest.mark.skip(reason="Test is not implemented")
    @pytest.mark.timeout(500, method='thread')
    def test_fleur_eos_structure_Si(self, run_with_cache, mock_code_factory):
        """
        Full regression test of FleurEosWorkChain starting with a crystal structure and parameters
        """
        assert False

    @pytest.mark.skip(reason="Test is not implemented")
    @pytest.mark.timeout(500, method='thread')
    def test_fleur_eos_structure_non_cubic(self, run_with_cache, mock_code_factory):
        """
        Full regression test of FleurEosWorkChain starting with a crystal structure and parameters
        """
        assert False
    ...
    @pytest.mark.skip(reason="Test is not implemented")
    @pytest.mark.timeout(500, method='thread')
    def test_fleur_eos_one_simulation_fails(self, run_with_cache, mock_code_factory):
        """
        Full regression test of FleurEosWorkChain starting with a fleurinp data,
    ...
    @pytest.mark.skip(reason="Test is not implemented")
    @pytest.mark.timeout(500, method='thread')
    def test_fleur_eos_validation_wrong_inputs(self, run_with_cache, mock_code_factory):
        """
