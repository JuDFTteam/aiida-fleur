...
class Test_FleurScfWorkChain():
    ...
    @pytest.mark.skip(reason='fleur executable fails here, test prob works')
    @pytest.mark.timeout(500, method='thread')
    def test_fleur_scf_structure_W(self, run_with_cache, mock_code_factory, generate_structure2):
        """
    ...
    def test_fleur_scf_validation_wrong_inputs(
        self, run_with_cache, mock_code_factory, create_fleurinp, generate_structure2
    ):
        """
