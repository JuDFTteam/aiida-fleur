...
class TestAiida_fleur_entrypoints:
    ...
    def test_fleur_fleurinpmodifier_entry_point(aiida_profile):
        from aiida.orm import DataFactory
    ...
    def test_inpgen_parser_entry_point(aiida_profile):
    ...
    def test_fleur_parser_entry_point(aiida_profile):
        from aiida.parsers import ParserFactory
    ...
    def test_fleur_scf_wc_entry_point(aiida_profile):
    ...
    def test_fleur_dos_wc_entry_point(aiida_profile):
        from aiida.orm import WorkflowFactory
    ...
    def test_fleur_band_wc_entry_point(aiida_profile):
        from aiida.orm import WorkflowFactory
    ...
    def test_fleur_eos_wc_entry_point(aiida_profile):
        from aiida.orm import WorkflowFactory
    ...
    #def test_fleur_inital_cls_wc_entry_point(aiida_profile):
    #    from aiida.orm import WorkflowFactory
    ...
    def test_fleur_corehole_wc_entry_point(aiida_profile):
        from aiida.orm import WorkflowFactory
