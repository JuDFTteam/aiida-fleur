...
class TestAiida_fleur_entrypoints:
    ...
    def test_fleur_mae_conv_wc_entry_point(aiida_env):
        from aiida.plugins import WorkflowFactory
    ...
    def test_fleur_base_wc_entry_point(aiida_env):
        from aiida.plugins import WorkflowFactory
    ...
    def test_fleur_base_relax_wc_entry_point(aiida_env):
        from aiida.plugins import WorkflowFactory
    ...
    def test_fleur_create_magnetic_wc_entry_point(aiida_env):
        from aiida.plugins import WorkflowFactory
