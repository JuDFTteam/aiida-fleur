...
inpxmlfile = '/usr/users/iff_th1/broeder/aiida/github/aiida_fleur_plugin/tests/inp_xml_files/NiO_ldauXML/files/inp.xml'
symout = '/usr/users/iff_th1/broeder/aiida/github/aiida_fleur_plugin/tests/inp_xml_files/NiO_ldauXML/files/sym.out'
...
calc = code.new_calc()
calc.label = "NiO_ldau Fleur test"
calc.description = ("Simple test of Fleur with one steps:"
                    "1.Generate a starting density and run 9 iterations and "
