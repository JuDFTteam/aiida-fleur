...
inpxmlfile = '/usr/users/iff_th1/broeder/aiida/github/aiida_fleur_plugin/tests/inp_xml_files/NaWO/files/inp.xml'
...
calc.description = ("Simple test of Fleur band structure calculation with XML input with one step:"
                    "1.Generate a starting density, run 9 iteration")
