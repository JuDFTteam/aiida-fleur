...
|-|-|-|-|
| `v2.0.0 < v3.0.0` | ![Compatibility for v2.0][AiiDA v2.0] |  [![PyPI pyversions](https://img.shields.io/badge/python-3.8_\|_3.9_\|_3.10-blue)](https://pypi.org/project/aiida-fleur.svg) |![Fleur Compatibility][Fleur v2.0]/`<=0.36` |
